...
//   return (
//     <section id="projects" className="py-24 sm:py-32 border-b border-line overflow-hidden">
//       <div className="container-px flex items-end justify-between gap-6 mb-14">
//         <div>
//           <motion.p
