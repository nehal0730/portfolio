...
// This mirrors backend/src/data/portfolio.ts. It renders instantly on load,
// then App.tsx silently refreshes from GET /api/portfolio/all once the API responds.
